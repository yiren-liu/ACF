...
class ImpDataset(object):
    ...
    def __init__(self,path):
        self.trainPosSet, self.num_users , self.num_items  = self.load_rating_file_as_set(path + "Input/train.tsv")
        self.testPosSet, _, _ = self.load_rating_file_as_set(path + "Input/test.tsv")
        self.testPair2NegList = self.load_negative_file_as_dict(path + "Input/test.negative.tsv")
