...
class Dataset(object):
    ...
    #     print maxlen
        ...
        with open('test.txt','r') as file:
            for line in file.readlines():
                featureData.append(eval(line.split(' ',1)[1]))
        np_data=np.array(featureData)
        np_data=np_data.reshape(np_data.shape[0],10,-1)
    ...
    def get_batch(self):
        ...
        for iii in xrange(self.batch_size):
            ...
            #max_item means the number of items which the user interacts
